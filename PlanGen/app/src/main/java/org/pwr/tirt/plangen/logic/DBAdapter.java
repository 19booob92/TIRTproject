...
public class DBAdapter {
    ...
    public static final String DATETIME_OPTIONS = "TEXT";
    public static final int DATETIME_COLUMN = 3;
    ...
    public static final int TUTOR_COLUMN = 5;
    ...
    public boolean insertData(Event event) {
        ...
        newValues.put(KEY_DATETIME, event.dateTime);
    ...
    public Event getData(long id) {
        String[] columns = {KEY_ID, KEY_TITLE, KEY_TYPE, KEY_DATETIME, KEY_LOCATION, KEY_TUTOR};
        String where = KEY_ID + "=" + id;
        ...
        if(cursor != null && cursor.moveToFirst()) {
            ...
            event.dateTime = cursor.getString(DATETIME_COLUMN);
    ...
    public ArrayList<Event> getDailyEvents (Date date) {
        ...
        Cursor cursor;
        if(date != null) {
            String where = KEY_DATETIME + "=" + date.toString(); //TODO: test on date
